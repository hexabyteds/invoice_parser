// Country -> dial code reference data for the signup/profile phone
// fields. Mirrored in utils/countries.js on the backend so the dropdown
// and the server-side check agree on both the country list and each
// entry's dial code; keep the two files in sync if this list changes.
