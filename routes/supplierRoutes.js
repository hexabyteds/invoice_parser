...
router.post("/", requireActiveSubscription, requireCompanyPermission("suppliers", "create"), (req, res) =>
...
router.put("/:id", requireActiveSubscription, requireCompanyPermission("suppliers", "edit"), (req, res) =>
    supplierController.update(req, res)
);

router.patch("/:id/status", requireActiveSubscription, requireCompanyPermission("suppliers", "edit"), (req, res) =>
    supplierController.updateStatus(req, res)
);

router.delete("/:id", requireActiveSubscription, requireCompanyPermission("suppliers", "delete"), (req, res) =>
