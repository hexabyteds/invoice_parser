...
class CustomerService {
    ...
    async create(userId, data) {
        ...
        await usageService.reserveCustomerSlot(userId);
        ...
        try {
            ...
            await usageService.decrementCustomers(userId);
            throw err;
        }
        ...
        return await customerRepository.findById(id, userId);
    }

    async getAll(userId) {
        return await customerRepository.findByUser(userId);
    }
    ...
    async update(id, userId, data) {
        ...
        await customerRepository.update(id, userId, merged);
    ...
    async updateStatus(id, userId, status) {
        ...
        await customerRepository.updateStatus(id, userId, status);
    ...
    async delete(id, userId) {
        ...
        await customerRepository.delete(id, userId);
