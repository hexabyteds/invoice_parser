...
class SupplierService {
    ...
    async create(userId, data) {
        ...
        return await supplierRepository.findById(id, userId);
    }

    async getAll(userId) {
        return await supplierRepository.findByUser(userId);
    }

    async update(id, userId, data) {

        const existing = await supplierRepository.findById(id, userId);
        ...
        await supplierRepository.update(id, userId, merged);
    ...
    async get(id, userId) {
        ...
        const supplier = await supplierRepository.findById(id, userId);
    ...
    async updateStatus(id, userId, status) {
        ...
        await supplierRepository.updateStatus(id, userId, status);
